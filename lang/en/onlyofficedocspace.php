...
$string['privacy:metadata:onlyofficedocspace_dsuser:password'] = 'DocSpace user\'s passwrod hash.';
$string['privacy:metadata:onlyofficedocspace_users'] = 'User information which used for creating in DocSpace.';

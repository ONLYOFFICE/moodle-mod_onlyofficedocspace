...
$string['confirmchanges'] = 'Confirm changes';
...
$string['docspacerequesterror'] = 'DocSpace request has failed. Please check your DocSpace settings and try again.';
...
$string['docspaceunauthorized'] = 'Request failed due to authentication or permission error. Please check your DocSpace credentials.';
...
$string['settingsdescription:apikey'] = 'The API key must be created by a DocSpace admin and should include the following access scopes: Profile (Read), Contacts (Write), and Rooms (Write).';
$string['settingsfield:apikey'] = 'ONLYOFFICE DocSpace API key';

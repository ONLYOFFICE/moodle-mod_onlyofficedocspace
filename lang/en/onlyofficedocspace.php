...
$string['privacy:metadata:onlyofficedocspace_admin'] = '';
$string['privacy:metadata:onlyofficedocspace_admin:login'] = '';
$string['privacy:metadata:onlyofficedocspace_admin:password'] = '';
$string['privacy:metadata:onlyofficedocspace_dsuser'] = '';
$string['privacy:metadata:onlyofficedocspace_dsuser:email'] = '';
$string['privacy:metadata:onlyofficedocspace_dsuser:password'] = '';
$string['privacy:metadata:onlyofficedocspace_users'] = '';
$string['privacy:metadata:onlyofficedocspace_users:email'] = '';

...
$string['privacy:metadata:onlyofficedocspace_admin'] = 'Informationen zum DocSpace-Administrator.';
$string['privacy:metadata:onlyofficedocspace_admin:login'] = 'DocSpace Admin-Anmeldung.';
$string['privacy:metadata:onlyofficedocspace_admin:password'] = 'DocSpace Admin-Passwort.';
$string['privacy:metadata:onlyofficedocspace_dsuser'] = 'In der Datenbank gespeicherte Informationen über DocSpace-Benutzer.';
$string['privacy:metadata:onlyofficedocspace_dsuser:email'] = 'E-Mail des DocSpace-Benutzers';
$string['privacy:metadata:onlyofficedocspace_dsuser:password'] = 'Passwort-Hash des DocSpace-Benutzers';
$string['privacy:metadata:onlyofficedocspace_users'] = 'Benutzerinformationen, die zum Erstellen in DocSpace verwendet werden.';
$string['privacy:metadata:onlyofficedocspace_users:email'] = 'E-Mail des Moodle-Benutzers';

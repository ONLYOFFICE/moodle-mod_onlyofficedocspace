...
$string['confirmchange_desc'] = 'Wenn Sie die Schaltfläche Ändern drücken, müssen Sie die Anmeldeinformationen für den aktuell verbundenen ONLYOFFICE DocSpace erneut eingeben. Verbindungen zwischen Räumen und Aktivitäten können verloren gehen. Informationen zum optionalen Benutzerexport werden nicht gelöscht.';
$string['confirmdisconnect_desc'] = 'Wenn Sie die Schaltfläche Trennen drücken, haben Sie keinen Zugriff mehr auf den aktuell verbundenen ONLYOFFICE DocSpace. Dadurch werden die Verbindungen zwischen Räumen und Aktivitäten entfernt und alle Benutzer getrennt.';

...
$string['cspwarning:body'] = 'Перед подключением, пожалуйста, перейдите в <b>Настройки DocSpace – Инструменты разработчика - JavaScript SDK</b> и добавьте адрес портала Moodle в список разрешений';
$string['cspwarning:head'] = 'Проверьте настройки CSP.';
...
$string['docspaceuserinviteerror'] = 'Не удалось выполнить процесс приглашения.';
...
$string['failedinvitations'] = 'Не удалось пригласить пользователя(ей) {$a}';

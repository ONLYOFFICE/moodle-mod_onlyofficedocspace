...
$string['confirmchange_desc'] = 'При нажатии кнопки «Изменить» нужно будет вновь ввести учетные данные для текущего подключенного ONLYOFFICE DocSpace. Связи между комнатами и действиями могут быть потеряны. Информация об опциональном экспорте пользователей не будет удалена.';
$string['confirmdisconnect_desc'] = 'Если вы нажмете кнопку «Отключить», у вас не будет доступа к текущему подключенному ONLYOFFICE DocSpace. Это приведет к разрыву соединений между комнатами и действиями и отключению всех пользователей.';

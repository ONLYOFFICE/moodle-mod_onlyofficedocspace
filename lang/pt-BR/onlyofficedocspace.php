...
$string['change'] = 'Mudar';
$string['confirmchange_desc'] = 'Se você clicar no botão Alterar, terá que inserir novamente as credenciais do DocSpace do ONLYOFFICE conectado no momento. As conexões entre Salas e Atividades podem ser perdidas. As informações sobre a exportação opcional de usuários não serão excluídas.';
$string['confirmdisconnect_desc'] = 'Se você pressionar o botão Desconectar, não terá acesso ao DocSpace do ONLYOFFICE conectado no momento. Isso removerá as conexões entre Salas e Atividades e desconectará todos os usuários.';

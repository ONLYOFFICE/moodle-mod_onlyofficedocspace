...
$string['docspaceuserrole:admin'] = 'Administrateur de salle';
$string['docspaceuserrole:power'] = 'Utilisateur avancé';
...
$string['docspaceuserstatus'] = 'Statut de l\'utilisateur de DocSpace';
...
$string['privacy:metadata:onlyofficedocspace_admin'] = 'Informations sur l\'administrateur de DocSpace.';
$string['privacy:metadata:onlyofficedocspace_admin:login'] = 'Login de l\'administrateur de DocSpace.';
$string['privacy:metadata:onlyofficedocspace_admin:password'] = 'Mot de passe de l\'administrateur de DocSpace.';
$string['privacy:metadata:onlyofficedocspace_dsuser'] = 'Informations sur l\'utilisateur de DocSpace stockées dans la base de données.';
$string['privacy:metadata:onlyofficedocspace_dsuser:email'] = 'E-mail de l\'utilisateur de DocSpace.';
$string['privacy:metadata:onlyofficedocspace_dsuser:password'] = 'Le hachage du mot de passe de l\'utilisateur de DocSpace.';
$string['privacy:metadata:onlyofficedocspace_users'] = 'Informations sur l\'utilisateur utilisées pour la création dans DocSpace.';
$string['privacy:metadata:onlyofficedocspace_users:email'] = 'E-mail de l\'utilisateur de Moodle.';

...
$string['confirmchange_desc'] = 'Si vous cliquez sur le bouton Modifier, vous devrez saisir à nouveau les identifiants pour ONLYOFFICE DocSpace actuellement connecté. Les connexions entre les salles et les activités pourraient être perdues. Les informations relatives à l\'exportation facultative des utilisateurs ne seront pas supprimées.';
$string['confirmdisconnect_desc'] = 'Si vous cliquez sur le bouton Déconnecter, vous n\'aurez plus accès au DocSpace ONLYOFFICE actuellement connecté. Cela supprimera les connexions entre les Salles et les Activités et déconnectera tous les utilisateurs.';

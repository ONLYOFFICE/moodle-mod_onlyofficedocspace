...
$string['cspwarning:body'] = 'Avant de vous connecter ici, veuillez vous rendre dans <b>Paramètres de DocSpace - Outils de développement - JavaScript SDK</b> et ajouter l’adresse du portail Moodle à la liste des adresses autorisées.';
$string['cspwarning:head'] = 'Vérifier les paramètres du CSP.';
...
$string['docspaceuserinviteerror'] = 'La procédure d’invitation a échoué.';
...
$string['failedinvitations'] = 'L’invitation a échoué pour {$a} utilisateur(s)';

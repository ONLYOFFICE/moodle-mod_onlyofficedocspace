...
$string['change'] = '更改';
$string['confirmchange_desc'] = '如果您点击“更改”按钮，必须重新输入当前连接的 ONLYOFFICE 协作空间凭据。房间和活动之间的连接可能会丢失。有关可选用户导出的信息不会被删除。';
$string['confirmdisconnect_desc'] = '如果您点击“断开连接”按钮，您将无法访问当前连接的 ONLYOFFICE 协作空间。这将删除房间和活动之间的连接，并断开所有用户的连接。';
$string['connect'] = '连接';

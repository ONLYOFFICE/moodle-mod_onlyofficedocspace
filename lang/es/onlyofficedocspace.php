...
$string['cspwarning:body'] = 'Antes de conectarse aquí, por favor, vaya a la <b>Configuración de DocSpace - Herramientas para desarrolladores - SDK de JavaScript</b> y añada la dirección del portal Moodle a la lista de permitidos';
$string['cspwarning:head'] = 'Comprobar la configuración CSP.';
...
$string['docspaceuserinviteerror'] = 'El proceso de invitación ha fallado.';
...
$string['failedinvitations'] = 'La invitación ha fallado para {$a} usuario(s)';

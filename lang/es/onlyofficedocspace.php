...
$string['privacy:metadata:onlyofficedocspace_admin'] = 'Información sobre el administrador de DocSpace.';
$string['privacy:metadata:onlyofficedocspace_admin:login'] = 'Inicio de sesión del administrador de DocSpace.';
$string['privacy:metadata:onlyofficedocspace_admin:password'] = 'Contraseña del administrador de DocSpace.';
$string['privacy:metadata:onlyofficedocspace_dsuser'] = 'Información sobre el usuario de DocSpace almacenada en la base de datos.';
$string['privacy:metadata:onlyofficedocspace_dsuser:email'] = 'Correo electrónico del usuario de DocSpace.';
$string['privacy:metadata:onlyofficedocspace_dsuser:password'] = 'Hash de la contraseña del usuario de DocSpace.';
$string['privacy:metadata:onlyofficedocspace_users'] = 'Información del usuario que se utiliza para crear en DocSpace.';
$string['privacy:metadata:onlyofficedocspace_users:email'] = 'Correo electrónico del usuario de Moodle.';

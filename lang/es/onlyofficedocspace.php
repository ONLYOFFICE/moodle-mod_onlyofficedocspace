...
$string['confirmchange_desc'] = 'Si haga clic en el botón Desconectar, ya no tendrá acceso al ONLYOFFICE DocSpace actualmente conectado. Esto eliminará las conexiones entre Salas y Actividades, y desconectará a todos los usuraios.';
$string['confirmdisconnect_desc'] = 'Si haga clic en el botón Cambiar, deberá que volver a ingresar las credenciales del ONLYOFFICE DocSpace actualmente conectado. Las conexiones entre Salas y Actividades podrían perderse. La infromación sobre la exportación opcional de usuarios no se eliminará.';
...
Todos los nuevos usuarios se añadirán con el <b>rol Usuario</b>, puede cambiar el rol en la <b>Configuración de cuentas de DocSpace</b>.<br/>

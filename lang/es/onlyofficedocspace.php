...
$string['docspaceuserscategory:description'] = 'Para añadir nuevos usuarios a ONLYOFFICE DocSpace y empezar a trabajar con el plugin, por favor haga clic en <b>{$a}</b>. Solo los usuarios con los roles Administrador, Profesor y Creador de cursos de Moodle pueden ser invitados a DocSpace. <br/> Todos los nuevos usuarios se añadirán con el rol <b>Usuario</b>. Puede cambiar el tipo de rol en la configuración Cuentas en DocSpace.';
...
$string['modulename_help'] = 'Este módulo permite a los usuarios conectar las salas de ONLYOFFICE DocSpace como actividades en Moodle para la colaboración.';
...
$string['privacy:metadata:onlyofficedocspace_admin'] = 'Este plugin envía las credenciales de administrador de DocSpace al servicio externo ONLYOFFICE DocSpace para la autenticación.';
$string['privacy:metadata:onlyofficedocspace_admin:login'] = 'El nombre de usuario del administrador se envía al servicio externo para autenticar las solicitudes de la API.';
$string['privacy:metadata:onlyofficedocspace_admin:password'] = 'La contraseña del administrador se envía al servicio de terceros para su autenticación. Esto nunca se almacena dentro de Moodle y solo se utiliza durante la comunicación segura de la API.';

...
$string['confirmchange_desc'] = 'Se premi il pulsante Cambia, dovrai reinserire le credenziali per l’ONLYOFFICE DocSpace attualmente connesso. I collegamenti tra Stanze e Attività potrebbero andare persi. Le informazioni sull’esportazione opzionale degli utenti non verranno eliminate.';
$string['confirmdisconnect_desc'] = 'Se premi il pulsante Disconnetti, non avrai più accesso all’ONLYOFFICE DocSpace attualmente connesso. Questo rimuoverà i collegamenti tra Stanze e Attività e disconnetterà tutti gli utenti.';

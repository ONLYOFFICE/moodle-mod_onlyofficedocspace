...
$string['privacy:metadata:onlyofficedocspace_admin'] = 'Informazioni sull\’amministratore di DocSpace.';
$string['privacy:metadata:onlyofficedocspace_admin:login'] = 'Login dell\’amministratore di DocSpace.';
$string['privacy:metadata:onlyofficedocspace_admin:password'] = 'Password dell\’amministratore di DocSpace.';
$string['privacy:metadata:onlyofficedocspace_dsuser'] = 'Informazioni sull\’utente DocSpace salvato nel database.';
$string['privacy:metadata:onlyofficedocspace_dsuser:email'] = 'Email dell\’utente di DocSpace.';
$string['privacy:metadata:onlyofficedocspace_dsuser:password'] = 'Hash della password dell\'utente DocSpace.';
$string['privacy:metadata:onlyofficedocspace_users'] = 'Informazioni sull\’utente utilizzate per creare in DocSpace.';
$string['privacy:metadata:onlyofficedocspace_users:email'] = 'Email dell\'utente Moodle.';

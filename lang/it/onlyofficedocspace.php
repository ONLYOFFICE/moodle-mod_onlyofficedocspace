...
$string['cspwarning:body'] = 'Prima di connettersi qui, vai sulle impostazioni del <b>DocSpace - Strumenti per sviluppatori - JavaScript SDK</b> e aggiungi l’indirizzo del portale di Moodle alla lista dei permessi';
$string['cspwarning:head'] = 'Controlla le impostazioni CSP.';
...
$string['docspaceuserinviteerror'] = 'Processo d’invito fallito.';
...
$string['failedinvitations'] = 'Invito non riuscito per {$a} utente(i)';

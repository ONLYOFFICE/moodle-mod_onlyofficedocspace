...
$string['cspwarning'] = '<b>CSPの設定を確認してください。</b><br/>接続する前に、<b>DocSpace設定→開発者ツール→JavaScript SDK</b>に移動し、Moodleポータルのアドレスを許可リストに追加してください - <u class="font-weight-bold">{$a}</u>';
...
$string['docspaceuseralreadyexists'] = 'ユーザー{$a}はDocSpaceにすでに存在しています！';
$string['docspaceuserinviteerror'] = 'DocSpaceでユーザー{$a}を作成中にエラーが発生しました！ 有料DocSpaceユーザーの制限に達している可能性があります。';
$string['docspaceusernotfound'] = 'ユーザーはONLYOFFICE DocSpaceで見つかりませんでした。管理者に連絡してください。';
$string['docspaceuserrole:admin'] = 'ルームの管理者';
$string['docspaceuserrole:power'] = 'パワーユーザー';
...
$string['emptyselection'] = 'ご返信をこちらに入力してください';
$string['enterfullscreen'] = '全画面表示';
$string['exitfullscreen'] = '全画面表示を終了';
$string['exportusers'] = 'コメントをこちらに入力してください';
$string['failedinvitations'] = '{$a}ユーザーの招待に失敗しました。 有料DocSpaceユーザーの人数制限に達している可能性があります。';
...
$string['privacy:metadata:onlyofficedocspace_admin'] = 'DocSpace管理者に関する情報';
$string['privacy:metadata:onlyofficedocspace_admin:login'] = 'DocSpace管理者のログイン';
$string['privacy:metadata:onlyofficedocspace_admin:password'] = 'DocSpace管理者のパスワード';
$string['privacy:metadata:onlyofficedocspace_dsuser'] = 'データベースに保存されているDocSpaceユーザーに関する情報';
$string['privacy:metadata:onlyofficedocspace_dsuser:email'] = 'DocSpaceユーザーのメールアドレス';
$string['privacy:metadata:onlyofficedocspace_dsuser:password'] = 'DocSpaceユーザーのパスワードハッシュ';
$string['privacy:metadata:onlyofficedocspace_users'] = 'DocSpaceに登録するために使用されるユーザー情報';
$string['privacy:metadata:onlyofficedocspace_users:email'] = 'Moodleユーザーのメールアドレス';
$string['rolewarning'] = '現在のMoodleユーザーは、DocSpaceに<b>ルーム管理者</b>の役割で追加されます';

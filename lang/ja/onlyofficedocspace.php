...
$string['change'] = '変更';
$string['confirmchange_desc'] = '「変更」を押すと、現在接続中のONLYOFFICE DocSpaceの認証情報を再入力する必要があります。ルームとアクティビティ間の接続が失われる可能性があります。オプションのユーザーエクスポートに関する情報は削除されません。';
$string['confirmdisconnect_desc'] = '「切断」を押すと、現在接続中のONLYOFFICE DocSpaceへアクセスできなくなります。ルームとアクティビティ間の接続が削除され、すべてのユーザーが切断されます。';
$string['connect'] = '接続';
